...
static ::_pb::Metadata file_level_metadata_Proto_2fproject_2eproto[8];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_Proto_2fproject_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_Proto_2fproject_2eproto = nullptr;

const uint32_t TableStruct_Proto_2fproject_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_Proto_2fproject_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023Proto/project.proto\022\004chat\"V\n\nnewMessag"
  "e\022\024\n\014message_type\030\001 \002(\010\022\016\n\006sender\030\002 \002(\t\022"
  "\021\n\trecipient\030\003 \001(\t\022\017\n\007message\030\004 \002(\t\",\n\014U"
  "serRegister\022\020\n\010username\030\001 \002(\t\022\n\n\002ip\030\002 \002("
  "\t\"5\n\017UserInfoRequest\022\024\n\014type_request\030\001 \002"
  "(\010\022\014\n\004user\030\002 \001(\t\"3\n\014ChangeStatus\022\020\n\010user"
  "name\030\001 \002(\t\022\021\n\tnewStatus\030\002 \002(\005\"\265\001\n\013UserRe"
  "quest\022\016\n\006option\030\001 \002(\005\022#\n\007newUser\030\002 \001(\0132\022"
  ".chat.UserRegister\022*\n\013infoRequest\030\003 \001(\0132"
  "\025.chat.UserInfoRequest\022\"\n\006status\030\004 \001(\0132\022"
  ".chat.ChangeStatus\022!\n\007message\030\005 \001(\0132\020.ch"
  "at.newMessage\"8\n\010UserInfo\022\020\n\010username\030\001 "
  "\001(\t\022\n\n\002ip\030\002 \001(\t\022\016\n\006status\030\003 \001(\005\";\n\021AllCo"
  "nnectedUsers\022&\n\016connectedUsers\030\001 \003(\0132\016.c"
  "hat.UserInfo\"\347\001\n\016ServerResponse\022\016\n\006optio"
  "n\030\001 \002(\005\022\014\n\004code\030\002 \002(\005\022\025\n\rserverMessage\030\003"
  " \002(\t\022/\n\016connectedUsers\030\004 \001(\0132\027.chat.AllC"
  "onnectedUsers\022!\n\007message\030\005 \001(\0132\020.chat.ne"
  "wMessage\022(\n\020userInfoResponse\030\006 \001(\0132\016.cha"
  "t.UserInfo\022\"\n\006change\030\007 \001(\0132\022.chat.Change"
  "Status"
  ;
static ::_pbi::once_flag descriptor_table_Proto_2fproject_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_Proto_2fproject_2eproto = {
    false, false, 806, descriptor_table_protodef_Proto_2fproject_2eproto,
    "Proto/project.proto",
    &descriptor_table_Proto_2fproject_2eproto_once, nullptr, 0, 8,
    schemas, file_default_instances, TableStruct_Proto_2fproject_2eproto::offsets,
    file_level_metadata_Proto_2fproject_2eproto, file_level_enum_descriptors_Proto_2fproject_2eproto,
    file_level_service_descriptors_Proto_2fproject_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_Proto_2fproject_2eproto_getter() {
  return &descriptor_table_Proto_2fproject_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_Proto_2fproject_2eproto(&descriptor_table_Proto_2fproject_2eproto);
namespace chat {
...
::PROTOBUF_NAMESPACE_ID::Metadata newMessage::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Proto_2fproject_2eproto_getter, &descriptor_table_Proto_2fproject_2eproto_once,
      file_level_metadata_Proto_2fproject_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata UserRegister::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Proto_2fproject_2eproto_getter, &descriptor_table_Proto_2fproject_2eproto_once,
      file_level_metadata_Proto_2fproject_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata UserInfoRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Proto_2fproject_2eproto_getter, &descriptor_table_Proto_2fproject_2eproto_once,
      file_level_metadata_Proto_2fproject_2eproto[2]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ChangeStatus::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Proto_2fproject_2eproto_getter, &descriptor_table_Proto_2fproject_2eproto_once,
      file_level_metadata_Proto_2fproject_2eproto[3]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata UserRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Proto_2fproject_2eproto_getter, &descriptor_table_Proto_2fproject_2eproto_once,
      file_level_metadata_Proto_2fproject_2eproto[4]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata UserInfo::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Proto_2fproject_2eproto_getter, &descriptor_table_Proto_2fproject_2eproto_once,
      file_level_metadata_Proto_2fproject_2eproto[5]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata AllConnectedUsers::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Proto_2fproject_2eproto_getter, &descriptor_table_Proto_2fproject_2eproto_once,
      file_level_metadata_Proto_2fproject_2eproto[6]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ServerResponse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Proto_2fproject_2eproto_getter, &descriptor_table_Proto_2fproject_2eproto_once,
      file_level_metadata_Proto_2fproject_2eproto[7]);
}
